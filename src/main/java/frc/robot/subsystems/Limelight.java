...
public class Limelight extends SubsystemBase
{
    ...
    public Limelight()
    {
        ...
        tx = m_NetworkTable.getEntry("tx");
        ty = m_NetworkTable.getEntry("ty");
        ta = m_NetworkTable.getEntry("ta");
        tv = m_NetworkTable.getEntry("tv");
    ...
    public void periodic() 
    {
        ...
        tx.getDouble(0.0); //target x
        ty.getDouble(0.0); //target y
        ty.getDouble(0.0); //target area
        tv.getBoolean(false); //target visible
        ...
        //TankDriveSubsystem.odometry.addVisionMeasurement(botpose_limelight, Timer.getFPGATimestamp());
